...
export const confirmEmail = (confirm_token) => axios.post(BACKEND_API+'/v1/user/confirmEmail/'+confirm_token);
export const resendConfirmEmail = (email) => axios.post(BACKEND_APIv+'/v1/user/resendConfirmEmail/'+email);
export const forgotPassword = (email) => axios.post(BACKEND_API+'/v1/user/forgotPassword/'+email);
export const isValidResetPasswordToken = (reset_token) => axios.post(BACKEND_API+'/v1/user/isValidResetPasswordToken/'+reset_token);
export const resetPassword = (resetToken, password) => axios.post(BACKEND_API+'/v1/user/resetPassword',{resetToken,password});
...
export const getProfile = (token) => axios.post(BACKEND_API+'/v1/user/getProfile', null, {headers: {Authorization: "Bearer "+token}});
...
// for indonesia
export const registerEmailIndonesia = (email, ip) => axios.post(BACKEND_API+'/v1/user/registerIndonesia',{email,ip});