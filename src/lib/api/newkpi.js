...
export const getNewKPI = (searchData) => axios.post(BACKEND_API+'/v1/kpi/listnew', {...searchData});
...
export const getItemSaleKPI = (searchData) => axios.post(BACKEND_API+'/v1/kpi/listSaleItem', {...searchData});
